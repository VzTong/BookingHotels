namespace App.Share.Consts
{
	public static class AuthConst
	{
		...
		{
			public const int MANAGE_ALL_USER_FILES		= 1201;
		}
		...
		public static class AppHotel
		{
			...
			public const int PUBLIC						= 1605;
			public const int UNPUBLIC					= 1606;
		}
		public static class AppRoom
		{
			...
			public const int PUBLIC						= 1705;
			public const int UNPUBLIC					= 1706;
		}
		...
		public static class AppEquipmentType
		{
			...
			public const int UPDATE						= 2003;
			public const int DELETE						= 2004;
		}
		public static class AppPayroll
		{
			public const int VIEW_LIST					= 2101;
			public const int VIEW_DETAIL				= 2102;
			public const int CREATE						= 2103;
			public const int UPDATE						= 2104;
			public const int DELETE						= 2105;
		}
		public static class AppWorkSchedule
		{
			public const int VIEW_LIST					= 2201;
			public const int VIEW_DETAIL				= 2202;
			public const int CREATE						= 2203;
			public const int UPDATE						= 2204;
			public const int DELETE						= 2205;
		}
		public static class AppWorkShift
		{
			public const int VIEW_LIST					= 2301;
			public const int VIEW_DETAIL				= 2302;
			public const int CREATE						= 2303;
			public const int UPDATE						= 2304;
			public const int DELETE						= 2305;
		}
		public static class AppOrder
		{
			public const int VIEW_LIST					= 2401;
			public const int DETAILS					= 2402;
		...
		public static class AppComment
		{
			...
			public const int AD_DELETE					= 2502;
		}
	}
}